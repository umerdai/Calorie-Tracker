...
const PackagesOffered = () => {
  return (
    <div data-aos="fade-up" data-aos-anchor-placement="bottom-bottom" className='pt-8'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="flex flex-col items-center mx-4 border p-4 h-full">
            ...
            <ul className="flex-grow">
              ...
              <li>• Visualize your calorie intake and expenditure with charts.</li>
              <li>• Get support through email.</li>
              <li>• Access to a limited number of meal recipes and suggestions.</li>
            </ul>
          ...
          <div className="flex flex-col items-center mx-4 border p-4 h-full">
            ...
            <ul className="flex-grow">
              ...
              <li>• Access to a broader range of meal recipes and suggestions.</li>
          ...
          <div className="flex flex-col items-center mx-4 border p-4 h-full">
            ...
            <ul className="flex-grow">
              <li>• Access to an extensive library of recipes and meal ideas.</li>
              ...
              <li>• In-depth analysis of your calorie tracking and progress.</li>
